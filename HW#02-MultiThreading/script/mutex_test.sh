...
PRODUCER_COUNTS=(100)
CONSUMER_COUNTS=(100)
OUTPUT_FILE="/home/minhyuk/OperatingSystem/HW#02-Multi_Threaded_Word_Count/HW#02-MultiThreading/src/Mutex/mutex_execution_time.txt"
...
for P in "${PRODUCER_COUNTS[@]}"; do
    for C in "${CONSUMER_COUNTS[@]}"; do
        ...
        EXEC_TIME=$(/home/minhyuk/OperatingSystem/HW#02-Multi_Threaded_Word_Count/HW#02-MultiThreading/src/Mutex/word_count $READFILE_2 $P $C | grep "Execution Time" | awk '{print $3}')
